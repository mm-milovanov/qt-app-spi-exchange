...
@echo off
SET BASE_DIR=%~dp0
SET PATH=%BASE_DIR%/bin/;%BASE_DIR%/lib/;%PATH%;%BASE_DIR%/lib/systemLibs
SET CQT_PKG_ROOT=%BASE_DIR%
SET CQT_RUN_FILE=%BASE_DIR%app-spi-exchange.bat



start "app-spi-exchange" /B "%BASE_DIR%/bin/app-spi-exchange.exe" %*
